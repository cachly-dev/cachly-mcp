...
export function pruefe(lage) {
  ...
  return {
    ...
    meldung: [
      ...
      '',
      'Der Sprung zieht die Werkzeug-Schnappschuesse mit (npm-Haken "version"):',
      'docs/generated/tool-specs/ traegt die Nummer, sonst wird der Drift Guard',
      'rot. Die geaenderten Dateien gehoeren mit in den Commit.',
      '',
