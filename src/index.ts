  ...
  if (!JWT) {
    ...
    if (flow) {
      ...
      return [
        ...
        '',
        '✨ Free forever · No credit card · 96 MCP tools · GDPR · EU servers',
      ].join('\n');
    }
...
if (!process.argv[2] && process.stdout.isTTY) {
  ...
  console.log('  \x1b[90mFree forever · GDPR · German servers · 96 MCP tools\x1b[0m');
  console.log('');
  process.exit(0);
}
